<!DOCTYPE html><html lang="en"><head>
  ...
  <title>PRINCE JUNIOR V2 PAIR CODE</title>
  ...
  <style>
    body {
      ...
      height: 100vh;
      margin: 0;
      background-image: url("https://files.catbox.moe/5ig7g1.png"); /* Set the background image */
...
<body>
  <div class="container">
    <div class="main">
      <div class="box" id="box">
        <div id="text">
          ...
          <p>
            <h2 class="centered-text">PRINCE JUNIOR V2 PAIR</h2>           
            <h6>⚙Enter your number with country code.⚙</h6>
            <div class="input-container">
              <input placeholder="254723245807" type="number" id="number" placeholder="⚙Enter your phone number with country code⚙" name="">
    ...
    <div class="glowing-text">Powered By Junior Ezed</div>
  </div>
  ...
  <script>
    ...
    b.addEventListener("click", async (e) => {
      ...
      if (!c.value) {
        ...
        a.innerHTML = '<a style="color:black;font-weight:bold">Please hold🔎 </a><br><br>';
